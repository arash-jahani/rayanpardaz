...
public class ApiHelper {
    ...
    public static JsonObject getJsonResult(JsonObject json) {
       ...
       /*
     * In Method baraye sakhte url e api ha mibashad
     */
     public static String getApiPath(String domain, String function) {
        return String.format(MyConsts.ApiPath, MyConsts.ApiKey, domain, function);
    }
